...
| **SR-71 Blackbird** | KOG_THORNS (@ioai25312) | https://sketchfab.com/3d-models/lockheed-sr-71-blackbird-e2400e6119f5414c89e075654a82d30a | CC-BY 4.0 | `lockheed_sr-71_blackbird.glb` | 49k tris, 7 textures. Fast recon/interceptor (fighter class). Animated gear (box-extracted), afterburners. |
| **Avro Vulcan** (Avro698) | manilov.ap | https://sketchfab.com/3d-models/avro698-5259b4b3852a4cb4ad4b1745913ed039 | CC-BY 4.0 | `avro698.glb` | 36k tris, 31 textures (RAF camo + roundels), has gear. Cold War bomber. Gear animated (nose+2 main bogies); doors detached (phase-2 animation pending). |
